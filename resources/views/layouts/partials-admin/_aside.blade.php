				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{ route('admin.dashboard') }}" class="brand-logo m-auto">
							<img alt="Logo" height="30px" src="{{ asset('images/94nesha-areta.png') }}" />
						</a>
								...
								<li class="menu-item menu-item-submenu {{ Route::is('admin.report.formulir.*') ? 'menu-open menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item {{ Route::is('admin.report.formulir.penyintas_pasien_covid.*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
												<a href="{{ route('admin.report.formulir.penyintas_pasien_covid.') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Penyintas & Pasien Covid</span>
												</a>
											</li>
